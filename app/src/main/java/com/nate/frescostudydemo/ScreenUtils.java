...
public class ScreenUtils {
     ...
     * 动态设置图片宽高
     */
    public static float[] getBitmapConfiguration(ImageInfo bitmap, SimpleDraweeView imageView, float screenRadio) {
        ...
        if (bitmap == null) {
            ...
            radio = rawHeight / rawWidth;
            width = (float) (screenWidth / screenRadio);
            height = (float) (radio * width);
        }
        return new float[]{width, radio};
    }
}
